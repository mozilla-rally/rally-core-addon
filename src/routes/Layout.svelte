  ...
  <div class='split-content-modal' slot="body" style="margin-bottom: 24px; box-sizing: content-box;">
    <div style="width: 368px;">
      ...
      <ul class="mzp-u-list-styled bigger-gap" style="padding-right: 36px;">
        ...
        <li>If you are currently enrolled in an open study, we will <b>delete all data</b> we've collected through that study to date. However, researchers will still retain access to data you've contributed to <b>completed studies</b>.</li>
